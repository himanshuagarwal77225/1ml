...
public class GatterGetReletedProductList {
    String id,unique_code,vendor_id,vendor_name,pd_brand_name,pd_company_name,image,brand_name,company_name,mrp,sale_price;

    public GatterGetReletedProductList(String id, String unique_code, String vendor_id, String vendor_name, String pd_brand_name, String pd_company_name, String image, String brand_name, String company_name, String mrp, String sale_price) {
        this.id = id;
