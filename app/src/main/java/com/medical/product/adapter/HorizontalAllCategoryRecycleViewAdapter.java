...
public class HorizontalAllCategoryRecycleViewAdapter extends RecyclerView.Adapter<HorizontalAllCategoryRecycleViewAdapter.HorizontalRVViewHolder> {

    Context context;
    ArrayList<HorizontalModelSaveCategory> arrayList;


    public HorizontalAllCategoryRecycleViewAdapter(Context context,ArrayList<HorizontalModelSaveCategory> arrayList)
    {
    ...
    public void onBindViewHolder(final HorizontalRVViewHolder holder, final int position) {
        ...
        final HorizontalModelSaveCategory HorizontalModelCategory=arrayList.get(position);
