...
public class Sedulasadpater extends RecyclerView.Adapter<Sedulasadpater.MyViewHolder> {
    private ArrayList<Sedulas> duration; // this data structure carries our title and description
    Context context;
    ReminderAddActivity addActivity;

    public Sedulasadpater(ReminderAddActivity reminderAddActivity, ArrayList<Sedulas> duration, Context context) {
