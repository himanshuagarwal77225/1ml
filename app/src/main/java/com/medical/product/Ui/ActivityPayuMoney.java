...
public class ActivityPayuMoney extends BaseActivity implements View.OnClickListener {

    public static final String TAG = "ActivityPayuMoney : ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  amount_et.setFilters(new InputFilter[]{new DecimalDigitsInputFilter(7, 2)});
        ...
        ((BaseApplication) context).setAppEnvironment(AppEnvironment.SANDBOX);

      /*  if (settings.getBoolean("is_prod_env", false)) {
            ((BaseApplication) context).setAppEnvironment(AppEnvironment.PRODUCTION);
    ...
    private void setupCitrusConfigs() {
        ...
        if (appEnvironment == AppEnvironment.PRODUCTION) {
            Toast.makeText(ActivityPayuMoney.this, "Environment Set to Production", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(ActivityPayuMoney.this, "Environment Set to SandBox", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void launchPayUMoneyFlow() {
        ...
        String phone = "8769847255";
        String productName = "production";
        String firstName = "manu";
        String email = "manu15ap95@gmail.com";
        String udf1 = "";
        String udf2 = "";
        String udf3 = "";
        String udf4 = "";
...
/*            *//**
           ...
           if (AppPreference.selectedTheme != -1) {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,ActivityPayuMoney.this, AppPreference.selectedTheme,mAppPreference.isOverrideResultScreen());
            } else {
                PayUmoneyFlowManager.startPayUMoneyFlow(mPaymentParams,ActivityPayuMoney.this, R.style.AppTheme_default, mAppPreference.isOverrideResultScreen());
            }
    ...
    private class GetHashesFromServerTask extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(ActivityPayuMoney.this);
        ...
        protected void onPostExecute(String merchantHash) {
            ...
            if (merchantHash.isEmpty() || merchantHash.equals("")) {
                Toast.makeText(ActivityPayuMoney.this, "Could not generate hash", Toast.LENGTH_SHORT).show();
            } else {
